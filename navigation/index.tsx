...
function RootNavigator() {
  return (
    <Stack.Navigator initialRouteName="Home">
      ...
      <Stack.Screen name="Reminders" component={RemindersScreen} options={{ title: 'My Reminders' }}/>
      <Stack.Screen name="Friends" component={FriendsScreen} options={{ title: 'My Friends' }}/>
      <Stack.Screen name="SafeWalk" component={SafeWalkScreen} options={{ title: 'Safe Walk' }}/>
      <Stack.Screen name="GetInspired" component={GetInspiredScreen} options={{ title: 'Get Inspired' }}/>
